...
from the 'Run' menu 'Create Trace' or press ctrl-shift-t. This will generate a
trace of the execution of your current code with any lines preceded with '#>'
stripped out by the tracer and used to create the explanations/annotations seen
in the right upper box when the trace is played back. Multiple consecutive
annotations will be concatenated. Only code which is defined in the source file
will be traced into (though any code which is imported can be executed).
